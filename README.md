...
Three classes of pkhex flag the converter does not chase:

1. **Movesets pass through verbatim.** Whatever moves your Gen 1/2 mon currently knows are written into the Gen 3 record as-is. pkhex checks every move against the species's Gen 3 learnset (level-up + TM + tutor + egg-move) and may flag moves the species can't legally know in Gen 3.
...
3. **Hatched eggs are Lv 5 in Gen 3.** A bred egg in Gen 3 hatches at Lv 5, full stop. A Lv 4 Pidgey (or any sub-Lv-5 mon) will be flagged as inconsistent with the bred-egg origin.
